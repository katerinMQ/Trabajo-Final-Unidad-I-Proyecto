...
\begin{center}
	\includegraphics[width=12cm]{./imagen/Screenshot_2020-10-30_Code.png}
\end{center}
\begin{center}
...
\section{Cronograma }
	...
	\begin{center}
	\includegraphics[width=12cm]{./imagen/Screenshot_2020-10-31_ProyectoSistemaDiagnosticoMedicoTeamStoriesBoard-Boards.png}
	\end{center}

	\subsection{Duplications Overview}
	\begin{center}
	\includegraphics[width=12cm]{./imagen/Screenshot_2020-10-30_DuplicationsOverview.png}
	\end{center}

	\subsection{Maintainability Overview}
	\begin{center}
	\includegraphics[width=12cm]{./imagen/Screenshot_2020-10-30_MaintainabilityOverview.png}
	\end{center}

	\subsection{Project Overview}	
	\begin{center}
	\includegraphics[width=12cm]{./imagen/Screenshot_2020-10-30_ProjectOverview.png}
	\end{center}

	\subsection{Reliability Overview}	
	\begin{center}
	\includegraphics[width=12cm]{./imagen/Screenshot_2020-10-30_ReliabilityOverview.png}
	\end{center}

	\subsection{Security Overview}	
	\begin{center}
	\includegraphics[width=12cm]{./imagen/Screenshot_2020-10-30_SecurityOverview.png}
	\end{center}
